...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe(self):
        """Test creating recipe through the API"""
        payload = {
            'title': 'Sample recipe',
            'time_minutes': 30,
            'price': Decimal('5.99'),
    ...
    def test_delete_recipe_other_users_recipe(self):
        """Test deleting the other user's recipe returns error"""
        new_user = create_user(
            email='user2@example.com',
            password='test123'
        )
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 23,
            'price': '3.67',  # test if this approach works
